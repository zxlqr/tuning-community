...
⚠️ **ВАЖНО**: Не коммитьте дампы с реальными паролями и личными данными!

- Реальные дампы автоматически исключены из Git через `.gitignore`
- Используйте только тестовые данные для примеров дампов
- Храните реальные дампы локально или в безопасном месте
